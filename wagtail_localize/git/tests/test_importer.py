...
class TestImporter(TestCase):
    ...
    def test_importer(self):
        ...
        importer = Importer(logging.getLogger("dummy"))
    ...
    def test_importer_doesnt_import_if_dependency_not_translated(self):
        ...
        snippet_source, created = TranslationSource.from_instance(self.page.test_snippet)
        snippet_source.extract_segments()
        snippet_translation = Translation.objects.create(
            object=snippet_source.object,
            target_locale=self.locale,
        ...
        page_source, created = TranslationSource.from_instance(self.page)
        page_source.extract_segments()
